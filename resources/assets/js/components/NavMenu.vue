    ...
    data () {
      ...
      return {
        ...
        items: [
          ...
          { title: 'Quotes', icon: 'book', route:  {name: 'quotes'}, permission: user.isCompanyAdmin | user.isCompanyUser | user.isWholesaleAdmin },
          { title: 'Customer Quotes', icon: 'bookmark', route:  {name: 'customer-quotes'}, permission: user.isCompanyAdmin | user.isCompanyUser | user.isWholesaleAdmin },

...
import MidRailHeight from './product/shutter/MidRailHeight'
import BladeSize from './product/shutter/BladeSize'
...
Vue.component(MidRailHeight.name, MidRailHeight)
Vue.component(BladeSize.name, BladeSize)
Vue.component(TiltRod.name, TiltRod)
